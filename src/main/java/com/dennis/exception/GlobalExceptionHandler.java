...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(HospitalAppException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> hastahaneOtomasyonuHandler(HospitalAppException hastahaneOtomasyonuException){
        return new ResponseEntity<>(createErrorMessage(hastahaneOtomasyonuException,hastahaneOtomasyonuException.getErrorType()),
                hastahaneOtomasyonuException.getErrorType().getHttpStatus());
    }
